...
i18nDefaults.create.title = "<h3 style='margin-bottom:0px'>"+i18nDefaults.create.title+"</h3>";
i18nDefaults.edit.title = "<h3 style='margin-bottom:0px'>"+i18nDefaults.edit.title+"</h3>";
i18nDefaults.remove.title = "<h3 style='margin-bottom:0px'>"+i18nDefaults.remove.title+"</h3>";
